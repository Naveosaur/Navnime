...
const Navbar = () => {
  ...
  return (
    <div>
      <nav className={changeColor ? "w-full bg-[#141414] text-white fixed transition duration-300 z-10 opacity-80" : " w-full  bg-transparent text-white fixed transition duration-300 z-10"}>
